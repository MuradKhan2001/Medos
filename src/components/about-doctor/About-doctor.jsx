                ...
                <div className="header">
                    ...
                    <div className="infotmation-doctor">
                        ...
                        <div className="social-medias-icons">
                            {doctor.doctor_socials && doctor.doctor_socials.map((item, index) => {
                        ...
                        <div className="skills">
                            {doctor.sub_speciality && doctor.sub_speciality.map((item, index) => {
                    ...
                    <div className="buttons">
                        ...
                        <div className="date">
                            ...
                            {doctor.working_days && doctor.working_days.map((itemWorking, index) => {
                                return <p key={index}>
                                    &nbsp;
